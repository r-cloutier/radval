...
\tabletypesize{\small}
\tablecaption{Relative occurrence rates of close-in terrestrial and gaseous planets around low mass stars\label{tab:rel}}
\tablehead{Stellar mass & $f_{\mathrm{terr}}$ & $f_{\mathrm{gas}}$ & $f_{\mathrm{terr}}/f_{\mathrm{gas}}$ \\
