...
\enddata
\tablecomments{The $r_p$ boundaries on the radius valley are given implicitly by the upper $r_p$ limit of the terrestrial peak and the lower $r_p$ limit of the gaseous peak.}
\end{deluxetable*}
