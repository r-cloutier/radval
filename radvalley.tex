...
\textbf{Here we present a broad comparison of the occurrence rates of small close-in planets around
...
\textbf{We consider the 126 PCs from the transiting planet search in \ktwo{} campaigns 0-8 \citep{kruse19}.
  ...
  consistent with that from \kepler{.} This indicates that the \kepler{} and
