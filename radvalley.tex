...
\author{Kristen Menou\altaffilmark{3,2}}
...
(see \autoref{fig:Ndet}) despite our stellar sample containing $\sim 4.4$ times more stars osberved by
\ktwo{} than by \kepler{} 
...
planet occurrence rates. \textbf{Explicitly, we measure cumulative occurrence rates of
...
The properties of the resulting 18 planets are listed in \autoref{table:rhop}. \textbf{Based on the
  ...
  than that of a pure water world (i.e. 100\% H$_2$O) given the planet's size, 
  and all remaining planets are flagged as having an \emph{ambiguous} bulk composition (i.e. not clearly
...
\textbf{Here we present a non-exhaustive comparison of the occurrence rates of small close-in planets around
  ...
  $2.48\pm 0.32$ and $0.75\pm 0.11$ planets per star respectively. However, noting that 
...
\textbf{We consider the 126 PCs from the transiting planet search in \ktwo{} campaigns 0-8 \citep{kruse19}.
  ...
  of PCs from \cite{kruse19} now makes the \ktwo{} measurement
  consistent with the cumulative occurrence rate from \kepler{} indicating that the \kepler{} and
  ...
  as many low mass dwarf stars as \kepler{.}
}
...
versus insolation. \textbf{We measure the slope using a similar methodology to \cite{martinez19} wherein
  the two-dimensionsal occurrence rates are first resampled from its MAP value and uncertainties in
...
%We measure the slope by resampling $10^3$ planet populations from the inverse
...
%linear function as depicted in \autoref{fig:fmapF}.
...
\citep{zeng16}. Hence, the transition radius is predicted to occur at larger planet radii with increasing
...
% what does it mean to measure the valley location 

% change characterization of planet dispositions from bulk density to whether or not the planet is above or below the 70%rock - 30% iron curve in MR space  

% derive the K2 occurrence rate around mid-K and M dwarfs from Kruse sample of PCs and compare it to their results from Kepler to show
% that hoepfully they're the same
