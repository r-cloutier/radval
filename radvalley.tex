...
Also included in Fig.~\ref{fig:fmap} are planets
...
The vast majority of the retrieved planets in Fig.~\ref{fig:fmap}
...
The inclusion of planets with $\geq 3\sigma$ bulk density measurements (see Table~\ref{table:rhop}) in
...
between $1.4-1.6$ R$_{\oplus}$ (TOIs 175.01, 406.01, and 667.01). 
