...
\begin{abstract}
  ...
  completeness corrections %to the empirical planet population
  ...
  which increases from $0.5\pm 0.1$ around mid-K dwarfs to $8.5\pm 4.6$ around mid-M dwarfs.
  ...
  The measurements presented herein precisely indicate the subset of planetary orbital periods and radii
...
linear function as depicted in \autoref{fig:fmapF}. Over the $10^3$ realizations of resampled planet
populations, we measure an average slope and standard deviation of
$\text{d}r_p / \text{d}\log{F} = -0.12\pm 0.05$. Similarly, repeating this exercise in the $P-r_p$
space yields $\text{d}r_p / \text{d}\log{P} = 0.11\pm 0.08$. For ease of reference, the slopes measured
...
\begin{figure*}
  ...
  \caption{(\emph{Interactive figure})
    ...
    to be $\text{d}r_p / \text{d}\log{F} = -0.12\pm 0.05$ which is consistent with predictions
...
The negative slope of $\text{d}r_p / \text{d}\log{F} = -0.12$ indicates that the location of the radius valley
...
consistent with our measured scaling between $r_{p,\text{valley}}$ and $\log{F}$ of $-0.12\pm 0.05$.
...
The differing observational findings in each stellar mass regime may either be interpreted as
...
$\text{d}r_p/\text{d}\log{P} = 0.11$ and $\text{d}\log{r_p}/\text{d}\log{P} = -0.11$ in the low mass and Sun-like stellar
...
\item The radius valley around low mass stars exhibits a negative slope with insolation
  ($\text{d}r_p / \text{d}\log{F} = -0.12\pm 0.05$) unlike 
