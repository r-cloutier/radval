...
and the minimum $f_j$ of the valley ($r_p \sim 1.6$ R$_{\oplus}$) decreases from 0.070 to 0.054 R$_{\oplus}$
%(i.e. $3.2\sigma \to 2.9\sigma$).
Contamination by true FPs in the planet sample containing
