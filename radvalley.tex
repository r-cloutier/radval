...
\begin{abstract}
  ...
  The latter notion is supported by the relative occurrence of terrestrial to gaseous planets
  ...
  \textbf{These measurements precisely indicate the subset of planetary orbital periods and radii
    that should be targeted in radial velocity surveys to resolve the rocky-to-gaseous transition
...
leads to the transition from terrestrial to gaseous planets emerging due to the
...
of terrestrial planets as being primoridally rocky or an evaporated core requires additional information
...
predominantly terrestrial and gaseous planets. \autoref{fig:transition} highlights the region of interest for resolving
the rocky-to-gaseous transition in the $P-r_p$ space. This region is defined by the intermediate region between the
...
\noindent \textbf{These subsets of the $P-r_p$ space define the regions of interest for resolving the
  rocky-to-gaseous transition around low mass stars. For example, at $P\lesssim 23.52$ days thermally driven
...
\begin{figure}
  ...
  \caption{Regions of interest for resolving the transition between terrestrial and gaseous planets
    ...
    \autoref{fig:fmap}. The rocky-to-gaseous transition measured in this work is highlighted
...
\item The gaseous planet peak in the bimodal occurrence rates is centered at $\sim 2$ R$_{\oplus}$ and effectively
...
\item The occurrence rate-weighted location of the radius valley---and the central radius of each planet peak---shift
  to smaller
  sizes with decreasing stellar mass. The slope of the gaseous planet peak's central radius with stellar mass is
  twice that of the terrestrial peak's slope indicating that the planet population in each stellar mass bin
...
\item We advocate that transiting planets around stars with \teff{} $<4700$ K, and whose orbital periods and radii are
  situated between model predictions of the location of the rocky-to-gaseous transition (see \autoref{fig:transition}),
