...
\begin{figure*}
  ...
  \caption{(\emph{Interactive figure}) Empirical population of confirmed close-in planets around low mass stars.
    ...
    and \ktwo{}
    \ToggleLayer{fig:on4,fig:off4}{\protect\cdbox{(\emph{circles and diamonds} respectively)}}
...
\begin{figure*}
  \centering
  %\includegraphics[width=\hsize]{figures/fmap_bkgd_Msgt0d0_xbin39_ybin26.png}%
  \hspace{-\hsize}%
  \begin{ocg}{fig:off3}{fig:off3}{0}%
  \end{ocg}%
  \begin{ocg}{fig:on3}{fig:on3}{1}%
  %\includegraphics[width=\hsize]{figures/fmap_kepk2_Msgt0d0_xbin39_ybin26.png}%
  \end{ocg}
  \hspace{-\hsize}%
  \begin{ocg}{fig:off1}{fig:off1}{0}%
  \end{ocg}%
  \begin{ocg}{fig:on1}{fig:on1}{1}%
  %\includegraphics[width=\hsize]{figures/fmap_curve_Msgt0d0_xbin39_ybin26.png}%
  \end{ocg}
  \hspace{-\hsize}%
  \begin{ocg}{fig:off4}{fig:off4}{0}%
  \end{ocg}%
  \begin{ocg}{fig:on4}{fig:on4}{1}%
  %\includegraphics[width=\hsize]{figures/fmap_planets_Msgt0d0_xbin39_ybin26.png}%
  \end{ocg}
  \hspace{-\hsize}%
...
\begin{figure*}
  ...
  \end{ocg}
  \hspace{-0.85\hsize}%
  \begin{ocg}{fig:off2}{fig:off2}{0}%
  \end{ocg}%
  \begin{ocg}{fig:on2}{fig:on2}{1}%
  ...
  \end{ocg}
  \hspace{-0.85\hsize}%
  %\includegraphics[trim=0cm 0 0 -4cm, width=.85\hsize]{figures_tmp/fmapF_martinez/fmapF_martinez001.png}
  \caption{(\emph{Interactive figure})
    ...
    \ToggleLayer{fig:on1,fig:off1}{\protect\cdbox{(\emph{small circles and diamonds})}}.
    Overplotted in black are
    \ToggleLayer{fig:on3,fig:off3}{\protect\cdbox{model predictions}} of the transition from rocky to non-rocky
    ...
    \ToggleLayer{fig:on2,fig:off2}{\protect\cdbox{slope of the radius valley}}
...
\begin{figure*}
  \centering
  %\includegraphics[width=\hsize]{figures/rpvMsFULL_KepK2_bkgd.png}%
  \hspace{-\hsize}%
  \begin{ocg}{fig:off4}{fig:off4}{0}%
  \end{ocg}%
  \begin{ocg}{fig:on4}{fig:on4}{1}%
  %\includegraphics[width=\hsize]{figures/rpvMsFULL_KepK2_models.png}%
  \end{ocg}
  \hspace{-\hsize}%
  \begin{ocg}{fig:off1}{fig:off1}{0}%
  \end{ocg}%
  \begin{ocg}{fig:on1}{fig:on1}{1}%
  %\includegraphics[width=\hsize]{figures/rpvMsFULL_KepK2_FP18.png}%
  \end{ocg}
  \hspace{-\hsize}%
  \begin{ocg}{fig:off3}{fig:off3}{0}%
  \end{ocg}%
  \begin{ocg}{fig:on3}{fig:on3}{1}%
  %\includegraphics[width=\hsize]{figures/rpvMsFULL_KepK2_bin.png}%
  \end{ocg}
  \hspace{-\hsize}%
  \begin{ocg}{fig:off2}{fig:off2}{0}%
  \end{ocg}%
  \begin{ocg}{fig:on2}{fig:on2}{1}%
  %\includegraphics[width=\hsize]{figures/rpvMsFULL_KepK2_Ms.png}%
  \end{ocg}
  \hspace{-\hsize}%
  \caption{(\emph{Interactive figure}) Evolution of the radius valley features with stellar mass. \emph{Solid markers}:
    ...
    retrieved from \cite{fulton18} \ToggleLayer{fig:on1,fig:off1}{\protect\cdbox{(\emph{open circles})}}.
    Feature radii from our full sample with a median value of
    $M_s = 0.651^{+0.058}_{-0.096}$ M$_{\odot}$ are depicted as
    \ToggleLayer{fig:on2,fig:off2}{\protect\cdbox{\emph{filled circles}}}.
    \ToggleLayer{fig:on3,fig:off3}{\protect\cdbox{\emph{Filled squares}}}
    ...
    \ToggleLayer{fig:on4,fig:off4}{\protect\cdbox{\emph{green curves}}}
