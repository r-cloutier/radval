...
\begin{abstract}
  ...
  low mass stars. This notion is supported by the relative occurrence of terrestrial to gaseous planets
...
stripping or by the growth of a volatile-rich secondary atmosphere \citep{shuvalov09,schlichting15,wyatt19}. 
Alternatively to the reprocessing of primorial atmospheres is the formation of distinct gaseous and
terrestrial planets with the latter invoking gas-poor formation wherein gas accretion is delayed by
dynamical friction whilst the
...
\begin{figure*}
  \centering %.48
  \includegraphics[width=.8\hsize]{figures_tmp/fmapF_Msgt0d0_xbin39_ybin26_insolation.png}
