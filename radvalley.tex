...
\begin{figure*}
  \centering
  %\includegraphics[width=.48\hsize]{figures/fmapF_Msgt0d0_xbin39_ybin26_insolation.png}
...
\item The radius valley around low mass stars exhibits a negative slope with insolation unlike 
  around Sun-like stars whose measured slope is positive. The observed negative slope
...
\item The gaseous planet peak in the bimodal occurrence rates, centered at $\sim 2$ R$_{\oplus}$, effectively
  vanishes around mid-M dwarfs as terrestrial planets ($\lesssim 1.6$ R$_{\oplus}$) increasingly dominate the
...
\item The occurrence rate-weighted central radius of each planet peak and the radius valley decrease to smaller
  ...
  tends to converge towards terrestrial planetary core sizes around later spectral types.
