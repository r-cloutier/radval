...
\begin{figure*}
  ...
  \caption{(\emph{Interactive figure}) Planet occurrence rate versus orbital period and planetary radius. The maximum a-posteriori occurrence
    ...
    \ktwo{} \ToggleLayer{fig:on3,fig:off3}{\protect\cdbox{(\emph{circles and diamonds})}} around low mass dwarf
    stars. For comparison, overplotted are the \ToggleLayer{fig:on1,fig:off1}{\protect\cdbox{empirical locations}}
...
\begin{figure*}
  ...
  %\includegraphics[width=.8\hsize]{figures/fmapF_bkgd_Msgt0d0_xbin39_ybin26_insolation.png}%
  \hspace{-\hsize}%
  \begin{ocg}{fig:off1}{fig:off1}{0}%
  \end{ocg}%
  \begin{ocg}{fig:on1}{fig:on1}{1}%
  %\includegraphics[width=.8\hsize]{figures/fmapF_models_Msgt0d0_xbin39_ybin26_insolation.png}%
  \end{ocg}
  \hspace{-\hsize}%
